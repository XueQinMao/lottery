...
export default function FeatureStatsToolbar() {
  ...
  return (
    <div className="type-tabs">
      ...
      <Link
        href="/feature-stats/tail"
        scroll={false}
        className={`type-tab ${pathname === "/feature-stats/tail" ? "active" : ""}`}
      >
        尾数
      </Link>
      <Link
        href="/feature-stats/cold-hot"
        scroll={false}
        className={`type-tab ${pathname === "/feature-stats/cold-hot" ? "active" : ""}`}
      >
        冷温热
      </Link>
    </div>
