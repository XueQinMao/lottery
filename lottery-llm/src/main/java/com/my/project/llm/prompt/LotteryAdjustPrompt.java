 ...
 * <p>双色球预测号码调优 Prompt：
 * <ol>
 *   <li>每组输出单式调整 + 该组复式（complexTicket）</li>
 *   <li>再综合输出一组最终可购买复式（finalComplexTicket）</li>
 * </ol>
 *
 ...
 *
 * <p>占位符：{report} / {tickets} / {format}
 *
 * @author 刘强
 * @version 2026/08/07 11:15
 **/
public final class LotteryAdjustPrompt {
    ...
    public static final String USER_PROMPT = """
            ...
            2. 红球替换：红球 1-33 互异升序共 6 个。在维持合理形态前提下，按优先级处理：
               ...
               (e) 和值越界：和值<90 → 将较小号换成更大的温/冷号；和值>130 → 将较大号换成更小的温/冷号；
                   basis 注明「和值校准至90-130」。
